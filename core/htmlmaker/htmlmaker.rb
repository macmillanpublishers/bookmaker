...
filecontents = File.read("#{Bkmkr::Paths.outputtmp_html}")
replace = filecontents.gsub(/(<span class="EndnoteReference" id=")(\d+)(">)(<\/span>)/,"\\1endnoteref-\\2\\3\\2\\4").gsub(/(<span class="Endnotereference" id=")(\d+)(">)(<\/span>)/,"\\1endnoteref-\\2\\3\\2\\4").gsub(/(<span class="endnotereference" id=")(\d+)(">)(<\/span>)/,"\\1endnoteref-\\2\\3\\2\\4").gsub(/(div class="endnotetext" id=")/,"\\1endnotetext-")
File.open("#{Bkmkr::Paths.outputtmp_html}", "w") {|file| file.puts replace}
